...
def step_gradient(b_current, m_current, points, learningRate):
       ...
       W1 = 0
       for i in range (0,len_):
           Wo += (b_current + m_current* points[i][0])-points[i][1]
           W1 += ((b_current+ m_current*points[i][0])-points[i][1]) * points[i][0]

       b_current -= learningRate * Wo / float(len_)
       m_current -= learningRate * W1 / float(len_)
